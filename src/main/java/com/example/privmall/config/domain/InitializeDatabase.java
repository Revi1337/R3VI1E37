        ...
        public void initialize() {
            ...
            IntStream.rangeClosed(1,2).forEach(value -> {
                ...
                Article article = Article.create()
                        ...
                        .title("[HackTheBox] Socket [MEDIUM]" + value)
                        .content(
                                """                   
                                ...
                                항상 열려있는 SSH 와 80 포트를 제외하고 5789 에서 돌아가는 `unknown` 서비스가 돌아가고있음을 알 수 있다.또한 80 포트에서 
                                돌아가는 Web Service 의 도메인이 `http://qreader.htb/` 이다.
                                
                                ![img.png](/api/post/image/img)
                                <br><br>
                                ...
                                ![img_3.png](/api/post/image/img_3)
                                <br><br>
                                ...
                                ![img_11.png](/api/post/image/img_11)
                                <br><br>
                                
                                자 이제 `SQLI` 를 하면된다. /version 에 조회했을때 출력된, `json` 의 key 개수만큼 `UNION` 의 select 절에 `null` 을 넣어준다음. 동일한\s
                                ...
                                ![img_12.png](/api/post/image/img_12)
                                <br><br>
                                ...
                                ![img_13.png](/api/post/image/img_13)
                                <br><br>
                                ...
                                ![img_14.png](/api/post/image/img_14)
                                <br><br>
                                ...
                                ![img_15.png](/api/post/image/img_15)
                                <br><br>
                                ...
                                ![img_16.png](/api/post/image/img_16)
                                <br><br>
                                
                                얻은 계정정보를 `CrackStation` 에 크랙을 맡겨주면 `denjanjade122566` 패스워드임을 확인할 수 있다.
                                
                                ![img_17.png](/api/post/image/img_17)
                                <br><br>
                                
                                이렇게 얻은 `admin:denjanjade122566` 계정정보를 ssh 에 로그인하면 될줄알았는데, 되지않았다.
                                여기서 시간 겁나많이 잡아먹었는데, 답이안나와 포럼을 보니까, `user` 테이블에서 계정정보를 얻는게 아니라고한다.
                                결론은 `reports` 테이블에 있는 있는 글에 나온 이름이라고한다. ~~문제진짜 드럽다~~ \s
                                여기서 또 겁나웃긴건 `ssh` 에 입력할떄 username 도 `tkeller` 라는 것이다.\s
                                
                                ![img_18.png](/api/post/image/img_18)
                                <br><br>
                                
                                ### Initial Access
                                
                                여튼 `tkeller` 계정으로 ssh 에 로그인해주고, `sudo -l` 으로 sudo 로 어떤커맨드를 사용할수있는지 확인해보면,
                                sudo 로 passwd 없이`build-installer.sh` 를 실행할 수 있다고 나와있다.\s
                                
                                ![img_19.png](/api/post/image/img_19)
                                <br><br>
                                
                                ### Privilege Escalation
                                
                                자 아래는 `build-installer.sh` 의 내용이다. 사진에 주석을 명시해주었지만, 간단하게 요약하자면\s
                                ...
                                ![img_22.png](/api/post/image/img_22)
                                <br><br>
                                
                                따라서 간단하게 exploit 코드를 작성해주고 sudo 로 스크립트를 실행해주면 Root 쉘을 따낼 수 있다.
                                
                                ![img_20.png](/api/post/image/img_20)
                                <br><br>
                                
                                ![img_21.png](/api/post/image/img_21)
                                <br><br>
