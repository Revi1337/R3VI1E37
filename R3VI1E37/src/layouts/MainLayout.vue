<template>
  ...
  <q-layout :style="{ padding: `0 ${layoutPadding}px !important` }">
    <q-header class="row justify-between no-wrap">
      ...
      <div class="col-auto text-right q-gutter-x-md row flex-center no-wrap">
        ...
        <q-btn v-if="isAuthenticated" rounded outline>
          <div class="row no-wrap">
            ...
            <span class="q-mx-sm">{{ nickname }}</span>
          </div>
        </q-btn>
        ...
        <q-btn
          ...
          @click="logoutStatus = !logoutStatus"
        />
      </div>
    </q-header>
  ...
  <q-dialog v-model="logoutStatus">
    <q-card dark class="logout-modal">
      <q-toolbar>
        <q-avatar size="4rem">
          <svg
            width="135.806"
      ...
      <q-card-section> <span class="text-h6">Are you sure you want to log out?</span> </q-card-section>

      <q-card-actions align="right">
        <q-btn outline label="logout" color="font-color" @click="clickLogout" v-close-popup />
        <q-btn outline label="cancel" color="font-color" v-close-popup />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
...
// clickLogout & logoutStatus (Modal)
